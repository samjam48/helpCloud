...
Redux-Minimal contains the bare minimum to develop a real world complex app and it also comes with a small bookings app that will show you how to code certain features.
...
3. Then open your [http://localhost:8080/](http://localhost:8080/) to see the included small bookings app. 
...
|-------|--------|--------|
|React|[`react`](https://github.com/facebook/react)|A declarative, efficient, and flexible JavaScript library for building booking interfaces|
...
Redux-Minimal also contains a small sample app that let's you manage some bookings with the following features:
* a list of bookings with pagination
* add a new booking
...
1. Open `webpack.config.js` and change the `app_root` value from `src_bookings` to `src`
